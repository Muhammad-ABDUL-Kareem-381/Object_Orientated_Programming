...
int String::giveLengthOfGivenString(const char* temp) const
{
...
void String::createString(char*& string, const int size) const
{
...
void String::copyStringByUsingLength(char* dest, const char* sour, const int size) const
{
	if (size <= 0)
	{
		dest = nullptr;
